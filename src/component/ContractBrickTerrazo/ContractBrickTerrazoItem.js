...
export default class ContractBrickTerrazoItem extends Component {
    constructor(props) {
        super(props);
    ...
    _renderMainContent() {
        return (
            <TouchableOpacity
                onPress={() => Actions.contractBrickTerrazoDetail({contract: this.props.contract})}
                activeOpacity={0.9}
            >
                <CardItem header>
                    <Left>
                ...
                <CardItem bordered>
                    ...
                    <Right>
                        <Body>
                            <Text style={styles.title}>{this.state.contract.tenLoaiGach}</Text>
                        </Body>
                    </Right>
                </CardItem>
                <CardItem bordered>
