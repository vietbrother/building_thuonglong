...
import BricksContractItem from "./BricksContractItem";
import styles from "../../styles/ContractStyles";


export default class BricksContracts extends Component {
    ...
    _renderItemResult(item) {
        ...
        return (
            <BricksContractItem key={item.id} contract={item}
                                   sessionKey={this.state.sessionKey}></BricksContractItem>
        );
    }
    ...
    async search(branchId, type) {
        ...
        try {
            ...
            let response = await fetch(global.hostAPI[0] + Config.api.apiBricksContract, {
                method: 'POST',
                headers: {
    ...
    render() {
        ...
        return (
            ...
            >
                <Container>
                    <Navbar left={left} right={right} title={Config.bricksContract.title}/>
                    <Content>
                        <View style={{
                            flex: 1,
