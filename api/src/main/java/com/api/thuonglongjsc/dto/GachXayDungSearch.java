...
public class GachXayDungSearch {
	private String ID;
	...
	public GachXayDungSearch() {
		super();
	}

	public GachXayDungSearch(String iD, Timestamp ngayThang, String tenChiNhanh, String tenLoaiGach, Integer soLuong,
			...
			String nguoiDuyetChot, Timestamp ngayTao, String nguoiTao) {
		super();
		ID = iD;
		NgayThang = ngayThang;
	...
	public String toString() {
		return "GachTerrazoSearch [ID=" + ID + ", NgayThang=" + NgayThang + ", TenChiNhanh=" + TenChiNhanh
				...
				+ SoMeTron1 + ", SoMeTron2=" + SoMeTron2 + ", TLMauXi=" + TLMauXi + ", TLMauDo=" + TLMauDo
				+ ", TLBotDa=" + TLBotDa + ", TLDaDen2ly=" + TLDaDen2ly + ", TLDaTrang2Ly=" + TLDaTrang2Ly
				+ ", TLDaTrang4Ly=" + TLDaTrang4Ly + ", TLXiMangPCB401=" + TLXiMangPCB401 + ", TLXiMangPCB402="
				+ TLXiMangPCB402 + ", TLMatDa=" + TLMatDa + ", TLCatSongDa=" + TLCatSongDa + ", TrangThaiText="
				+ TrangThaiText + ", TrangThaiChot=" + TrangThaiChot + ", NguoiDuyet=" + NguoiDuyet
				+ ", NguoiDuyetChot=" + NguoiDuyetChot + ", NgayTao=" + NgayTao + ", NguoiTao=" + NguoiTao + "]";
	}
