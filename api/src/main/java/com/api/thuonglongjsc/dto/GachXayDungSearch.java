...
public class GachXayDungSearch {
	...
	public GachXayDungSearch(String iDChiNhanh, String iDNhaCungCap, String tuNgay, String denNgay, String idHopDong,
	...
	public String toString() {
		return "GachXayDungSearch [IDChiNhanh=" + IDChiNhanh + ", IDNhaCungCap=" + IDNhaCungCap + ", TuNgay=" + TuNgay
