...
public class GiaBanVatLieu {
	...
	private Double TLTong;
	private Double TLBi;
	private Double TLHang;
	private Double TyLeQuyDoi;
	private Integer SoPhieuCan;
	private Double KLQuanCan;
	private Double KLBan;
	private Double KLXuatKho;
	...
	public GiaBanVatLieu(String iD, Date ngayThang, String tenChiNhanh, String iDChiNhanh, String tenNhaCungCap,
			String tenNhomVatLieu, String tenLoaiVatLieu, String tenDonViTinh, Double tLTong, Double tLBi,
			Double tLHang, Double tyLeQuyDoi, Integer soPhieuCan, Double kLQuanCan, Double kLBan, Double kLXuatKho,
			String tenBienSoXe, String tenLaiXe, BigDecimal donGiaCoThue, BigDecimal donGiaKhongThue, BigDecimal thanhTienCoThue,
			BigDecimal thanhTienKhongThue, Integer trangThai, String trangThaiText, Integer trangThaiChot, String nguoiDuyet,
			String nguoiDuyetChot, Date ngayTao, String nguoiTao) {
		super();
		ID = iD;
		NgayThang = ngayThang;
	...
	public Double getTLTong() {
		return TLTong;
	}

	public void setTLTong(Double tLTong) {
		TLTong = tLTong;
	}

	public Double getTLBi() {
		return TLBi;
	}

	public void setTLBi(Double tLBi) {
		TLBi = tLBi;
	}

	public Double getTLHang() {
		return TLHang;
	}

	public void setTLHang(Double tLHang) {
		TLHang = tLHang;
	}

	public Double getTyLeQuyDoi() {
		return TyLeQuyDoi;
	}

	public void setTyLeQuyDoi(Double tyLeQuyDoi) {
		TyLeQuyDoi = tyLeQuyDoi;
	}

	public Integer getSoPhieuCan() {
		return SoPhieuCan;
	}

	public void setSoPhieuCan(Integer soPhieuCan) {
		SoPhieuCan = soPhieuCan;
	}

	public Double getKLQuanCan() {
		return KLQuanCan;
	}

	public void setKLQuanCan(Double kLQuanCan) {
		KLQuanCan = kLQuanCan;
	}

	public Double getKLBan() {
		return KLBan;
	}

	public void setKLBan(Double kLBan) {
		KLBan = kLBan;
	}

	public Double getKLXuatKho() {
		return KLXuatKho;
	}

	public void setKLXuatKho(Double kLXuatKho) {
		KLXuatKho = kLXuatKho;
	}
	...
	public String toString() {
		return "GiaBanVatLieu [ID=" + ID + ", NgayThang=" + NgayThang + ", TenChiNhanh=" + TenChiNhanh + ", IDChiNhanh="
				+ IDChiNhanh + ", TenNhaCungCap=" + TenNhaCungCap + ", TenNhomVatLieu=" + TenNhomVatLieu
				+ ", TenLoaiVatLieu=" + TenLoaiVatLieu + ", TenDonViTinh=" + TenDonViTinh + ", TLTong=" + TLTong
				+ ", TLBi=" + TLBi + ", TLHang=" + TLHang + ", TyLeQuyDoi=" + TyLeQuyDoi + ", SoPhieuCan=" + SoPhieuCan
				+ ", KLQuanCan=" + KLQuanCan + ", KLBan=" + KLBan + ", KLXuatKho=" + KLXuatKho + ", TenBienSoXe="
				+ TenBienSoXe + ", TenLaiXe=" + TenLaiXe + ", DonGiaCoThue=" + DonGiaCoThue + ", DonGiaKhongThue="
