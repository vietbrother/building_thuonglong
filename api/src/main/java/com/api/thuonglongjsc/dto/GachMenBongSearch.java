...
public class GachMenBongSearch {
	...
	public GachMenBongSearch(String iDChiNhanh, String iDNhaCungCap, String tuNgay, String denNgay, String idHopDong,
	...
	public String toString() {
		return "GachMenBongSearch [IDChiNhanh=" + IDChiNhanh + ", IDNhaCungCap=" + IDNhaCungCap + ", TuNgay=" + TuNgay
