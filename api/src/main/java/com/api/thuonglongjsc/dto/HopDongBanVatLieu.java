...
public class HopDongBanVatLieu {
	...
	public HopDongBanVatLieu() {
		super();
	}

	public HopDongBanVatLieu(String iD, String tenChiNhanh, String congTrinh, String nhaCungCap, String nhomVatLieu,
